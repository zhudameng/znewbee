import { BelongsToManyRepository, Database } from '@znewbee/database';
import PluginACL from '@znewbee/plugin-acl';
import PluginCollectionManager from '@znewbee/plugin-collection-manager';
import UiSchemaStoragePlugin, { UiSchemaRepository } from '@znewbee/plugin-ui-schema-storage';
...
describe('server hooks', () => {
  ...
  beforeEach(async () => {
    ...
    uiSchemaPlugin = app.getPlugin<UiSchemaStoragePlugin>('@znewbee/plugin-ui-schema-storage');
  });
