...
function bindMenuToRole(_x) {
  return _bindMenuToRole.apply(this, arguments);
}

function _bindMenuToRole() {
  _bindMenuToRole = _asyncToGenerator(function* ({
    schemaInstance,
    db,
    options
  }) {
    ...
    var _iterator = _createForOfIteratorHelper(addNewMenuRoles),
        _step;
