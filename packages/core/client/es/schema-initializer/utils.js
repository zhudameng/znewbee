...
export var removeTableColumn = function removeTableColumn(schema, cb) {
  cb(schema.parent);
};
export var removeGridFormItem = function removeGridFormItem(schema, cb) {
  cb(schema, {
...
export var useRemoveGridFormItem = function useRemoveGridFormItem() {
  var form = useForm();
...
export var findTableColumn = function findTableColumn(schema, key, action) {
...
export var useRecordCollectionDataSourceItems = function useRecordCollectionDataSourceItems(componentName) {
