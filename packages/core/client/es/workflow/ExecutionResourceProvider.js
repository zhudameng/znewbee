...
export var ExecutionResourceProvider = function ExecutionResourceProvider(_ref) {
  var _request$params;

  var request = _ref.request,
      others = _objectWithoutProperties(_ref, _excluded);

  var workflow = useRecord();
  ...
  return /*#__PURE__*/React.createElement(ResourceActionProvider, _objectSpread({}, props));
};