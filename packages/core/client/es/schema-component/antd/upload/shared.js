...
export var isImage = function isImage(extName) {
  var reg = /\.(png|jpg|gif|jpeg|webp)$/;
  return reg.test(extName);
};
export var toMap = function toMap(fileList) {
  if (!fileList) {
    return [];
  }
...
export var toImages = function toImages(fileList) {
  if (!fileList) {
    return [];
  }
...
export var toArr = function toArr(value) {
  if (!isValid(value)) {
    return [];
  }
...
export var testOpts = function testOpts(ext, options) {
...
export var getImageByUrl = function getImageByUrl(url, options) {
...
export var getURL = function getURL(target) {
...
export var getThumbURL = function getThumbURL(target) {
...
export var getErrorMessage = function getErrorMessage(target) {
...
export var getState = function getState(target) {
...
export var normalizeFileList = function normalizeFileList(fileList) {
...
export var useValidator = function useValidator(validator) {
  var field = useField();
  useEffect(function () {
...
export var useUploadValidator = function useUploadValidator() {
...
export function useUploadProps(_ref) {
...
export var toItem = function toItem(file) {
...
export var toFileList = function toFileList(fileList) {
  return toArr(fileList).map(toItem);
};
export var toValue = function toValue(fileList) {
