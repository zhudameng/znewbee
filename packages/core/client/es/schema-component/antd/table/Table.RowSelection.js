...
var toArr = function toArr(value) {
  return isArr(value) ? value : isValid(value) ? [value] : [];
};

export var TableRowSelection = observer(function (props) {
  ...
  return /*#__PURE__*/React.createElement(TableVoid, _objectSpread(_objectSpread({}, props), {}, {
