...
export var useActionContext = function useActionContext() {
  var ctx = useContext(ActionContext);
...
export var useCloseAction = function useCloseAction() {
  var _useContext = useContext(ActionContext),
