...
var InsertMenuItems = function InsertMenuItems(props) {
  ...
  var _useDesignable = (0, _3.useDesignable)(),
  ...
  return /*#__PURE__*/_react2.default.createElement(_3.SchemaSettings.SubMenu, {
    eventKey: eventKey,
    title: title
  }, /*#__PURE__*/_react2.default.createElement(_3.SchemaSettings.ModalItem, {
...
var MenuDesigner = function MenuDesigner() {
  var field = (0, _react.useField)();
  var fieldSchema = (0, _react.useFieldSchema)();
  var api = (0, _3.useAPIClient)();

  var _useDesignable2 = (0, _3.useDesignable)(),
  ...
  var effects = function effects(form) {
    (0, _core.onFieldChange)('target', function (field) {
  ...
  return /*#__PURE__*/_react2.default.createElement(_3.GeneralSchemaDesigner, null, /*#__PURE__*/_react2.default.createElement(_3.SchemaSettings.ModalItem, {
    title: t('Edit'),
    schema: schema,
    ...
    onSubmit: function onSubmit(_ref7) {
      ...
      var current = (0, _.findByUid)(menuSchema, uid);
      var dn = (0, _2.createDesignable)({
        t: t,
        api: api,
        refresh: refresh,
        current: current
  ...
  }), /*#__PURE__*/_react2.default.createElement(_3.SchemaSettings.Divider, null), /*#__PURE__*/_react2.default.createElement(InsertMenuItems, {
    eventKey: 'insertbeforeBegin',
    title: t('Insert before'),
    insertPosition: 'beforeBegin'
  }), /*#__PURE__*/_react2.default.createElement(InsertMenuItems, {
  ...
  }), /*#__PURE__*/_react2.default.createElement(_3.SchemaSettings.Divider, null), /*#__PURE__*/_react2.default.createElement(_3.SchemaSettings.Remove, {
    confirm: {
