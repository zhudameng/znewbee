...
exports.Designable = void 0;
exports.createDesignable = createDesignable;
exports.splitWrapSchema = void 0;
exports.useDesignable = useDesignable;
...
function createDesignable(options) {
...
var splitWrapSchema = function splitWrapSchema(wrapped, schema) {
...
exports.splitWrapSchema = splitWrapSchema;

var translate = function translate(v) {
  return v;
};

var Designable = /*#__PURE__*/function () {
  ...
  _createClass(Designable, [{
    ...
    value: function insertBeforeBeginOrAfterEnd(schema) {
      ...
      if (!_react.Schema.isSchemaInstance(this.current)) {
        return;
      }
    ...
    value: function insertAfterBegin(schema) {
      ...
      this.prepareProperty(schema);
      var wrapped = wrap(schema);
      var s = this.current.addProperty(wrapped.name || (0, _shared.uid)(), wrapped);
      s['x-index'] = 0;
...
function useDesignable() {
  var _useContext = (0, _react2.useContext)(_context4.SchemaComponentContext),
  ...
  var _useContext2 = (0, _react2.useContext)(_react.SchemaOptionsContext),
  ...
  return {
    ...
    findComponent: function findComponent(component) {
      ...
      return (0, _get.default)(components, component);
    },
    on: dn.on.bind(dn),
    // TODO
