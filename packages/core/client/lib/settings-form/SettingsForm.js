...
exports.useSettingsFormContext = exports.SettingsFormContext = exports.SettingsForm = void 0;
...
var SettingsFormContext = /*#__PURE__*/(0, _react2.createContext)(null);
exports.SettingsFormContext = SettingsFormContext;

var useSettingsFormContext = function useSettingsFormContext() {
  return (0, _react2.useContext)(SettingsFormContext);
};

exports.useSettingsFormContext = useSettingsFormContext;
var SettingsForm = (0, _react.observer)(function (props) {
  var dn = (0, _.useDesignable)();
  ...
  var settingsFormSchema = (0, _react2.useMemo)(function () {
    return new _react.Schema(props.schema);
  }, []);
  ...
  return /*#__PURE__*/_react2.default.createElement(SettingsFormContext.Provider, {
    value: {
      dn: dn,
      field: field,
    ...
    overlay: /*#__PURE__*/_react2.default.createElement(_antd2.Menu, null, settingsFormSchema.mapProperties(function (s, key) {
      return /*#__PURE__*/_react2.default.createElement(_react.RecursionField, {
        name: key,
        schema: s
      });
    }))
  }, /*#__PURE__*/_react2.default.createElement("a", null, "\u914D\u7F6E")))))));
});
exports.SettingsForm = SettingsForm;

SettingsForm.Divider = function () {
  return /*#__PURE__*/_react2.default.createElement(_antd2.Menu.Divider, null);
};
...
SettingsForm.Switch = (0, _react.observer)(function () {
  var field = (0, _react.useField)();
  return /*#__PURE__*/_react2.default.createElement(_antd2.Menu.Item, {
    onClick: function onClick() {
  ...
  }, field.title, " ", /*#__PURE__*/_react2.default.createElement(_antd2.Switch, {
    checked: !!field.value
  })));
});
SettingsForm.Select = (0, _react.observer)(function (props) {
  var field = (0, _react.useField)();
  ...
  }, field.title, /*#__PURE__*/_react2.default.createElement(_antd2.Select, {
    open: open,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                setDropdownVisible(false);
                _context.next = 3;
                return (0, _antd.FormDialog)('Title', function () {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                setDropdownVisible(false);
                _context2.next = 3;
                return (0, _antd.FormDrawer)('Popup form', function () {
                  return /*#__PURE__*/_react2.default.createElement(_.SchemaComponentOptions, {
                    scope: options.scope,
                    components: _objectSpread(_objectSpread({}, options.components), {}, {
                      FormItem: _antd.FormItem
                    ...
                    schema: fieldSchema,
                    onlyRenderProperties: true
                  }), /*#__PURE__*/_react2.default.createElement(_antd.FormDrawer.Footer, null, /*#__PURE__*/_react2.default.createElement(_antd.FormButtonGroup, {
                    align: "right"
                  }, /*#__PURE__*/_react2.default.createElement(_antd.Reset, null, "Reset"), /*#__PURE__*/_react2.default.createElement(_antd.Submit, {
...
SettingsForm.SubMenu = function () {
  var field = (0, _react.useField)();
  var fieldSchema = (0, _react.useFieldSchema)();
  return /*#__PURE__*/_react2.default.createElement(_antd2.Menu.SubMenu, {
    title: field.title
...
SettingsForm.ItemGroup = function () {
  var field = (0, _react.useField)();
  var fieldSchema = (0, _react.useFieldSchema)();
  return /*#__PURE__*/_react2.default.createElement(_antd2.Menu.ItemGroup, {
    title: field.title
  }, fieldSchema.mapProperties(function (schema, key) {
    return /*#__PURE__*/_react2.default.createElement(_react.RecursionField, {
      name: key,
