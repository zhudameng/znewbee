...
exports.StrategyActions = void 0;
...
var StrategyActions = (0, _react.connect)(function (props) {
  ...
  return /*#__PURE__*/_react2.default.createElement("div", null, /*#__PURE__*/_react2.default.createElement(_antd.Table, {
    size: 'small',
    pagination: false,
    columns: [{
      ...
      render: function render(onNewRecord) {
        return onNewRecord ? /*#__PURE__*/_react2.default.createElement(_antd.Tag, {
          color: 'green'
        }, t('Action on new records')) : /*#__PURE__*/_react2.default.createElement(_antd.Tag, {
          color: 'geekblue'
      ...
      render: function render(enabled, action) {
        return /*#__PURE__*/_react2.default.createElement(_antd.Checkbox, {
          checked: enabled,
      ...
      render: function render(scope, action) {
        return !action.onNewRecord && /*#__PURE__*/_react2.default.createElement(_antd.Select, {
          size: 'small',
          value: scope,
          options: [{
            label: t('All records'),
...
exports.StrategyActions = StrategyActions;