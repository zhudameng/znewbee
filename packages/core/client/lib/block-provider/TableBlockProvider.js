...
exports.useTableBlockProps = exports.useTableBlockContext = exports.TableBlockProvider = exports.TableBlockContext = void 0;
...
var TableBlockContext = /*#__PURE__*/(0, _react2.createContext)({});
exports.TableBlockContext = TableBlockContext;
...
var InternalTableBlockProvider = function InternalTableBlockProvider(props) {
  ...
  return /*#__PURE__*/_react2.default.createElement(TableBlockContext.Provider, {
    value: {
      field: field,
      service: service,
      resource: resource,
...
var TableBlockProvider = function TableBlockProvider(props) {
  ...
  return /*#__PURE__*/_react2.default.createElement(_BlockProvider.BlockProvider, _objectSpread(_objectSpread({}, props), {}, {
    params: params
  }), /*#__PURE__*/_react2.default.createElement(InternalTableBlockProvider, _objectSpread(_objectSpread({}, props), {}, {
    params: params
  })));
};

exports.TableBlockProvider = TableBlockProvider;

var useTableBlockContext = function useTableBlockContext() {
  return (0, _react2.useContext)(TableBlockContext);
};

exports.useTableBlockContext = useTableBlockContext;

var useTableBlockProps = function useTableBlockProps() {
...
exports.useTableBlockProps = useTableBlockProps;