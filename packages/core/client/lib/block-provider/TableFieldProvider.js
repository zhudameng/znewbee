...
exports.useTableFieldProps = exports.useTableFieldContext = exports.TableFieldResource = exports.TableFieldProvider = exports.TableFieldContext = void 0;
...
var TableFieldContext = /*#__PURE__*/(0, _react2.createContext)({});
...
var TableFieldResource = /*#__PURE__*/function () {
...
exports.TableFieldResource = TableFieldResource;

var TableFieldProvider = function TableFieldProvider(props) {
  return /*#__PURE__*/_react2.default.createElement(_BlockProvider.BlockProvider, _objectSpread({
    block: 'TableField'
  }, props), /*#__PURE__*/_react2.default.createElement(InternalTableFieldProvider, _objectSpread({}, props)));
};

exports.TableFieldProvider = TableFieldProvider;

var useTableFieldContext = function useTableFieldContext() {
  return (0, _react2.useContext)(TableFieldContext);
};
...
exports.useTableFieldProps = useTableFieldProps;