...
exports.FormActionInitializers = FormActionInitializers;
var CreateFormActionInitializers = {
  title: '{{t("Configure actions")}}',
  icon: 'SettingOutlined',
  items: [{
    type: 'itemGroup',
...
exports.CreateFormActionInitializers = CreateFormActionInitializers;
var UpdateFormActionInitializers = {
  title: '{{t("Configure actions")}}',
  icon: 'SettingOutlined',
  items: [{
    type: 'itemGroup',
