...
var useCancelAction = function useCancelAction() {
...
var useResetFilterAction = function useResetFilterAction() {
...
exports.useResetFilterAction = useResetFilterAction;

var useKanbanEvents = function useKanbanEvents() {
...
exports.useKanbanEvents = useKanbanEvents;

var useSortFields = function useSortFields(collectionName) {
...
exports.useCollectionFilterOptions = useCollectionFilterOptions;

var useFilterDataSource = function useFilterDataSource(options) {
  var _useCollection2 = (0, _.useCollection)(),
...
exports.useFilterDataSource = useFilterDataSource;

var useFilterAction = function useFilterAction() {
...
exports.useFilterAction = useFilterAction;

var useCreateAction = function useCreateAction() {
  var form = (0, _react.useForm)();
  var ctx = (0, _schemaComponent.useActionContext)();

  var _useResourceActionCon3 = (0, _ResourceActionProvider.useResourceActionContext)(),
      refresh = _useResourceActionCon3.refresh;

  var _useResourceContext = (0, _ResourceActionProvider.useResourceContext)(),
...
var useCreateActionWithoutRefresh = function useCreateActionWithoutRefresh() {
  var form = (0, _react.useForm)();

  var _useResourceContext2 = (0, _ResourceActionProvider.useResourceContext)(),
...
exports.useCreateActionWithoutRefresh = useCreateActionWithoutRefresh;

var useUpdateViewAction = function useUpdateViewAction() {
  var form = (0, _react.useForm)();
  var ctx = (0, _schemaComponent.useActionContext)(); // const { refresh } = useResourceActionContext();

  var _useResourceContext3 = (0, _ResourceActionProvider.useResourceContext)(),
...
exports.useUpdateViewAction = useUpdateViewAction;

var useMoveAction = function useMoveAction() {
  var _useResourceContext4 = (0, _ResourceActionProvider.useResourceContext)(),
      resource = _useResourceContext4.resource;

  var _useResourceActionCon4 = (0, _ResourceActionProvider.useResourceActionContext)(),
...
exports.useMoveAction = useMoveAction;

var useUpdateAction = function useUpdateAction() {
  var form = (0, _react.useForm)();
  var ctx = (0, _schemaComponent.useActionContext)();

  var _useResourceActionCon5 = (0, _ResourceActionProvider.useResourceActionContext)(),
      refresh = _useResourceActionCon5.refresh;

  var _useResourceContext5 = (0, _ResourceActionProvider.useResourceContext)(),
      resource = _useResourceContext5.resource,
      targetKey = _useResourceContext5.targetKey;

  var _useRecord2 = (0, _recordProvider.useRecord)(),
...
var useDestroyAction = function useDestroyAction() {
  var _useResourceActionCon6 = (0, _ResourceActionProvider.useResourceActionContext)(),
      refresh = _useResourceActionCon6.refresh;

  var _useResourceContext6 = (0, _ResourceActionProvider.useResourceContext)(),
...
exports.useDestroyAction = useDestroyAction;

var useBulkDestroyAction = function useBulkDestroyAction() {
  var _useResourceActionCon7 = (0, _ResourceActionProvider.useResourceActionContext)(),
...
var useValuesFromRA = function useValuesFromRA(options) {
  var ctx = (0, _ResourceActionProvider.useResourceActionContext)();
  return (0, _apiClient.useRequest)(function () {
...
exports.useValuesFromRA = useValuesFromRA;

var useCreateActionAndRefreshCM = function useCreateActionAndRefreshCM() {
...
var useUpdateActionAndRefreshCM = function useUpdateActionAndRefreshCM() {
...
exports.useUpdateActionAndRefreshCM = useUpdateActionAndRefreshCM;

var useDestroyActionAndRefreshCM = function useDestroyActionAndRefreshCM() {
