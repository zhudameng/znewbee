...
exports.useSchemaTemplateManager = exports.useSchemaTemplate = exports.SchemaTemplateManagerProvider = exports.SchemaTemplateManagerContext = exports.RemoteSchemaTemplateManagerProvider = void 0;
...
var _BlockTemplate = require("./BlockTemplate");
...
var SchemaTemplateManagerContext = /*#__PURE__*/(0, _react2.createContext)({});
exports.SchemaTemplateManagerContext = SchemaTemplateManagerContext;

var SchemaTemplateRouteProvider = function SchemaTemplateRouteProvider(props) {
  var _useContext = (0, _react2.useContext)(_routeSwitch.RouteSwitchContext),
  ...
  return /*#__PURE__*/_react2.default.createElement(_routeSwitch.RouteSwitchContext.Provider, {
...
var SchemaTemplateManagerProvider = function SchemaTemplateManagerProvider(props) {
  var templates = props.templates,
      refresh = props.refresh;
  return /*#__PURE__*/_react2.default.createElement(SchemaTemplateManagerContext.Provider, {
    value: {
      templates: templates,
      refresh: refresh
    }
  }, /*#__PURE__*/_react2.default.createElement(SchemaTemplateRouteProvider, null, /*#__PURE__*/_react2.default.createElement(_schemaComponent.SchemaComponentOptions, {
    components: {
      BlockTemplate: _BlockTemplate.BlockTemplate
    }
  }, props.children)));
};
...
var useSchemaTemplate = function useSchemaTemplate() {
...
exports.useSchemaTemplate = useSchemaTemplate;

var useSchemaTemplateManager = function useSchemaTemplateManager() {
  var _useContext2 = (0, _react2.useContext)(SchemaTemplateManagerContext),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                regenerateUid(s);
                return _context.abrupt("return", (0, _lodash.cloneDeep)(s));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                s = (data === null || data === void 0 ? void 0 : data.data) || {};
                regenerateUid(s);
                return _context2.abrupt("return", (0, _lodash.cloneDeep)(s));
...
exports.useSchemaTemplateManager = useSchemaTemplateManager;

var RemoteSchemaTemplateManagerProvider = function RemoteSchemaTemplateManagerProvider(props) {
  var _service$data;
  ...
  return /*#__PURE__*/_react2.default.createElement(SchemaTemplateManagerProvider, {
    refresh: function () {
...
exports.RemoteSchemaTemplateManagerProvider = RemoteSchemaTemplateManagerProvider;